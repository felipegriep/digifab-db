CREATE DATABASE IF NOT EXISTS DIGIFAB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
CREATE USER IF NOT EXISTS 'digifab'@'localhost' IDENTIFIED BY 'digifab';
GRANT ALL PRIVILEGES ON digifab.* TO 'digifab'@'localhost';
FLUSH PRIVILEGES;
...
CREATE TABLE MATERIA_PRIMA_PRODUTO (
  ...
  ID_PRODUTO               BIGINT UNSIGNED NOT NULL,
  ID_MATERIA_PRIMA         BIGINT UNSIGNED NOT NULL,
  QUANTIDADE_UNIDADE       DECIMAL(12,3) NOT NULL,
  CRIADO_EM                DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ATUALIZADO_EM            DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
