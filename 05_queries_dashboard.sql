...
/*
┌────────────────────────────────────────────────────────────────────────────────┐
│  DASHBOARD • Produção & Reciclagem  ─  Período: 05–10/09/2025                  │
│  [Filtro de período] [Produto] [Linha] [MP]                                    │
├────────────────────────────────────────────────────────────────────────────────┤
│ KPIs                                                                           │
│  ┌─────────────┐  ┌───────────────────────┐  ┌────────────────┐  ┌──────────┐. │
│  │ OPs         │  │ Unid. Planejadas      │  │ MP Consumida   │  │ Lotes    │. │
│  │        15   │  │              44.750   │  │       457,7 kg │  │     15   │. │
│  └─────────────┘  └───────────────────────┘  └────────────────┘  └──────────┘. │
│  ┌───────────────────────┐                                                     │
│  │ Utilização Média      │                                                     │
│  │              25,43 %  │                                                     │
│  └───────────────────────┘                                                     │
│  (Queries: KPIs usam blocos 1–5 do 05_queries_dashboard.sql)                   │
├────────────────────────────────────────────────────────────────────────────────┤
│ Série: Produção por dia × linha (VW_PRODUCAO_POR_DIA_LINHA)                    │
│  DIA        LIN-001   LIN-002   LIN-003   LIN-004   TOTAL                      │
│  05/09      3.000     2.000     2.000         –      7.000                     │
│  06/09      2.000       750         –         –      2.750                     │
│  07/09          –         –     1.000       500      1.500                     │
│  08/09      4.000       500         –         –      4.500                     │
│  09/09          –     1.000     3.000         –      4.000                     │
│  10/09     10.000     5.000     8.000     2.000     25.000                     │
├────────────────────────────────────────────────────────────────────────────────┤
│ Top Produtos no período (VW_OP_BASICA)                                         │
│  TAMPA 28MM PEAD     | ████████████████████  19.000                            │
│  RÓTULO BOPP 500ML   | ████████████████      14.000                            │
│  GARRAFA PET 500ML   | ███████████           9.250                             │
│  POTE PEAD 1L        | ███                   2.500                             │
│  (Consulta B do arquivo de queries)                                            │
├────────────────────────────────────────────────────────────────────────────────┤
│ Consumo de MP por tipo (VW_CONSUMO_MP_POR_DIA / D)                             │
│  PEAD  █████████████████████████  263,8 kg  (57,6%)                            │
│  PET   ███████████████████         180,0 kg  (39,3%)                           │
│  PP    ██                             13,9 kg   (3,0%)                         │
├────────────────────────────────────────────────────────────────────────────────┤
│ Planejado × Consumido (agregado por MP)                                        │
│  MP    Planejado   Consumido   Desvio (kg)                                     │
│  PEAD    264,0       263,8       -0,2                                          │
│  PET     185,0       180,0       -5,0                                          │
│  PP       14,0        13,9       -0,1                                          │
│  (Consulta G do arquivo de queries)                                            │
├────────────────────────────────────────────────────────────────────────────────┤
│ Utilização por linha por dia (VW_UTILIZACAO_LINHA_DIA)                         │
│  DIA     LINHA    Programado  Cap.Estimada  Utilização                         │
│  05/09   LIN-001     3.000       12.000       25,0%                            │
│  05/09   LIN-002     2.000        8.000       25,0%                            │
│  05/09   LIN-003     2.000       20.000       10,0%                            │
│  ...     ...          ...           ...         ...                            │
│  10/09   LIN-001    10.000       12.000       83,3%                            │
│  10/09   LIN-002     5.000        8.000       62,5%                            │
│  10/09   LIN-003     8.000       20.000       40,0%                            │
│  10/09   LIN-004     2.000        4.000       50,0%                            │
│  (Consultas J/K do arquivo)                                                    │
├────────────────────────────────────────────────────────────────────────────────┤
│ Rastreabilidade (amostra) – VW_RASTREABILIDADE_CONSUMO                         │
│  OP              Produto           LoteProd     MP    LoteMP        Qtd   Data │
│  OP-20250910-002 GARRAFA 500ML     LP-GAR-...   PET   LMP-PET-...  95,0  10/09 │
│  OP-20250910-004 POTE PEAD 1L      LP-POT-...   PEAD  LMP-PEAD-... 20,0  10/09 │
│  OP-20250908-002 GARRAFA 500ML     LP-GAR-...   PET   LMP-PET-...  10,0  08/09 │
